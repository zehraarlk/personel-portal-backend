...
<html lang="tr">
  <head>
    ...
    <style>
      ...
      body::before {
        ...
        inset: 0;
        /* Örnek arka plan resmi - kendi resminizle değiştirin */
      ...
      .login-container {
        ...
        position: relative;
        z-index: 1;
        padding: 20px; /* Mobilde kenar boşlukları */
      }
      .login-box {
  ...
  <body>
    ...
    <script>
      ...
      // Form validation ve yönlendirme
      document.getElementById("loginForm").addEventListener("submit", function (e) {
        ...
        if (isValid) {
          ...
          // Kısa bir loading animasyonu sonrası yönlendir
          setTimeout(() => {
      ...
      // Input focus olayları için animasyon
