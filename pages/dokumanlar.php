...
// Filtre butonlarındaki İngilizce data-filter değerlerini,
// tablodaki Türkçe kategori adlarına eşliyoruz
$kategoriMap = [
      ...
      <div class="documents-grid" id="documentsGrid">
        <?php if (count($dokumanlar) > 0): ?>
          <?php foreach ($dokumanlar as $row):
              ...
              // Dosya uzantısına göre otomatik ikon (boyut satırında hep bu kullanılır)
              $extIcon = "fa-file-alt";
              if ($uzanti === "pdf") {
                  $extIcon = "fa-file-pdf";
              } elseif (in_array($uzanti, ["doc", "docx"])) {
                  $extIcon = "fa-file-word";
              } elseif (in_array($uzanti, ["xls", "xlsx"])) {
                  $extIcon = "fa-file-excel";
              }

              // Veritabanında özel bir ikon belirtilmişse başlıkta onu göster, yoksa uzantı ikonunu kullan
