...
$kategoriAdi = "Eğitimler";

$stmt = $db->prepare("SELECT id, baslik, aciklama, kategori, dosya_yolu, boyut, tarih FROM kaynaklar WHERE kategori = :kategori ORDER BY tarih DESC");
...
<html lang="tr">
  <head>
    ...
    />
    <link rel="stylesheet" href="../CSS/egitim.style.css" />
