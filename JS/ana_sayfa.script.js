document.addEventListener('DOMContentLoaded', function() {
    ...
    const detayGorseller = [ 
        { resim: "images/8-mart-dunya-kadinlar-gunu-programi_8383.jpg", baslik: "8 Mart Dünya Kadınlar Günü Programı", aciklama: "Kadın personelimizin özel günü kutlandı" }, 
        { resim: "images/24-kas-m-o-retmenler-gunu_2947.jpg", baslik: "24 Kasım Öğretmenler Günü Ziyareti", aciklama: "Öğretmenlerimizi unutmadık" }, 
        { resim: "images/personel-bayramla-ma-programi_5965.jpg", baslik: "Personel Bayramlaşma Programı", aciklama: "Geleneksel bayram buluşması" }, 
        { resim: "images/personel-ftar-program_109.jpg", baslik: "Personel İftar Programı", aciklama: "Ramazan birlikteliği" }, 
        { resim: "images/personel-p-kn-k-programi_9118.jpg", baslik: "Personel Piknik Programı", aciklama: "Doğayla baş başa keyifli anlar" }, 
        { resim: "images/personellerimizin-a-z-ve-di-sa-l-n-onemsiyoruz_7091.jpg", baslik: "Ağız ve Diş Sağlığı Taraması", aciklama: "Sağlık önceliğimiz" }, 
        { resim: "images/pesonel-ftar-programi_3732.jpg", baslik: "İkinci İftar Buluşması", aciklama: "Bereketin paylaşıldığı anlar" }, 
        { resim: "images/stajyer-donem-sonu-etk-nl_6028.jpg", baslik: "Stajyer Dönem Sonu Etkinliği", aciklama: "Başarılı staj dönemi sona erdi" }, 
        { resim: "images/stajyer-f-lm-okuma-programi_3604.jpg", baslik: "Stajyer Film Okuma Programı", aciklama: "Kültürel gelişim etkinlikleri" }, 
        { resim: "images/stajyer-o-renci-oryantasyonu_2177.jpg", baslik: "Stajyer Öğrenci Oryantasyonu", aciklama: "Yeni dönem hazırlıkları" }, 
        { resim: "images/stajyer-oryantasyon-e-t-m_8697.jpg", baslik: "Stajyer Oryantasyon Eğitimi", aciklama: "Kapsamlı eğitim programı" }, 
        { resim: "images/ulusal-da-bisikleti-kupas-yar-lar_128.jpg", baslik: "Ulusal Dağ Bisikleti Kupası", aciklama: "Heyecan dolu yarışlar" } 
    ];
...
function updateGalleryButtons() {
    ...
    [ 
        ...
        { resim: 'images/24-kas-m-o-retmenler-gunu_2947.jpg', baslik: 'Geleneksel Bayramlaşma Töreni Gerçekleşti', aciklama: 'Kurban Bayramı vesilesiyle tüm personelimizin katılımıyla coşkulu bir bayramlaşma programı yapıldı.' }, 
        ...
        { resim: 'images/personel-ftar-program_109.jpg', baslik: 'İkinci Geleneksel İftar Buluşması', aciklama: 'Personelimiz ve aileleriyle birlikte Ramazan ayının bereketini paylaştığımız iftar programımız.' }, 
        ...
        { resim: 'images/stajyer-oryantasyon-e-t-m_8697.jpg', baslik: 'Yeni Stajyerlerimize "Hoş Geldin" Dedik', aciklama: 'Belediye çalışmalarını yakından tanımaları için yeni stajyerlerimize yönelik bir oryantasyon yapıldı.' }, 
