document.addEventListener("DOMContentLoaded", () => {
  ...
  const videos = [
    ...
    {
      id: "GWfDmGr6tlg",
      title: "Yeni Personel İçin İSG Eğitimi",
      description:
    ...
    {
      id: "eUBQYWMZyH8",
      title: "Bayramlaşma Töreni Duyurusu",
      description:
    ...
    {
      id: "uUFZvM9kqf4",
      title: "Temel Ofis Programları Eğitimi",
      description: "Word, Excel ve PowerPoint kullanımı üzerine temel eğitim serisi.",
      category: "egitimler",
      duration: "55:20",
    },
    {
      id: "qdPXmtKXXc4",
      title: "Spor Turnuvası Kura Çekimi",
      description: "Birimler arası spor turnuvası için kura çekimi heyecanı.",
      category: "etkinlikler",
      duration: "12:50",
    },
    {
      id: "3ePuzpC2S0Q",
      title: "Yeni Servis Güzergahları Hk.",
      description: "Personel servis güzergahlarındaki değişiklikler hakkında duyuru.",
      category: "duyurular",
      duration: "04:18",
    },
    {
      ...
      description: "Daha verimli çalışmanın ipuçları bu eğitimde.",
      category: "egitimler",
      duration: "28:30",
    },
    {
      ...
      description: "Sosyal sorumluluk projemiz kapsamında gerçekleştirdiğimiz ziyaret.",
      category: "etkinlikler",
      duration: "07:25",
    },
    {
      id: "G2KNC3OAnjE",
      title: "Yıllık İzin Kullanımı Hakkında",
      description: "İnsan kaynaklarından izin kullanımı ile ilgili önemli duyuru.",
      category: "duyurular",
      duration: "02:55",
    },
    {
      ...
      description: "KVKK kanunu kapsamında personelimiz için zorunlu eğitim.",
      category: "egitimler",
      duration: "38:00",
    },
    {
      ...
      description: "Daha yeşil bir Gebze için personelimizle birlikte fidan diktik.",
      category: "etkinlikler",
      duration: "09:45",
    },
    {
      id: "YXat3fIWc7w",
      title: "Kantin Fiyat Düzenlemesi",
      description: "Yemekhane ve kantin fiyatları hakkındaki yeni düzenleme.",
      category: "duyurular",
      duration: "01:10",
    },
    {
      ...
      description: "İş hayatında stresi yönetmek için pratik bilgiler.",
      category: "egitimler",
      duration: "41:12",
    },
    {
      id: "-0Wxna6PjqQ",
      title: "Sokak Hayvanları Besleme Etkinliği",
      description: "Patili dostlarımızı unutmadık, onlarla bir gün geçirdik.",
      category: "etkinlikler",
      duration: "06:33",
    },
    {
      id: "c0vbYSFwMzU",
      title: "İş Elbiseleri Dağıtımı",
      description: "Yeni dönem iş elbiselerinin dağıtımıyla ilgili duyuru.",
      category: "duyurular",
      duration: "01:45",
    },
    {
      ...
      description: "Acil durumlara hazırlık kapsamında düzenlenen eğitim videosu.",
      category: "egitimler",
      duration: "18:55",
    },
    {
      id: "aUQ3uIAfL-k",
      title: "Geleneksel Aşure Günü",
      description: "Aşure gününde personelimizle bir araya geldik.",
      category: "etkinlikler",
      duration: "04:20",
    },
    {
      id: "D1b-CZYtCTg",
      title: "Portal Kullanım Kılavuzu",
      description: "Personel portalının nasıl daha etkin kullanılacağına dair video.",
      category: "duyurular",
      duration: "11:30",
    },
  ];
